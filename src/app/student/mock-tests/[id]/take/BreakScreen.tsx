...
export function BreakScreen(): React.ReactElement {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 dark:bg-[#0a0a0a]/80 backdrop-blur-sm flex items-center justify-center p-4">
      <Card className="max-w-md w-full bg-white dark:bg-[#131313] border-2 border-blue-500/30 space-y-6">
        {/* Header */}
        ...
        {/* Timer Display */}
        <div className="bg-slate-50 dark:bg-[#0a0a0a]/50 border border-slate-200 dark:border-white/10 rounded-lg p-6 text-center space-y-2">
        ...
        {/* Instructions */}
        <div className="bg-slate-50 dark:bg-[#0a0a0a]/30 border border-slate-200 dark:border-white/10 rounded-lg p-4 space-y-2">
        ...
        <button
          ...
          className="w-full py-3 rounded-lg font-bold flex items-center justify-center gap-2 transition-all duration-200 bg-blue-600 text-white hover:bg-blue-500 cursor-pointer shadow-md"
        >
          <Play className="w-5 h-5" /> Resume Testing / Skip Break →
        </button>
