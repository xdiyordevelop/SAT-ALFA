...
export default function PaymentsPage() {
  const [month, setMonth] = useState(() => {
    const d = new Date();
    return `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}`; // e.g. 2026-08
  });
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="bg-white dark:bg-[#131313] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white rounded-xl px-4 py-2 outline-none focus:border-yellow-500 transition-colors"
              />
            </div>
          </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400">
                            Monthly Fee:{" "}
                            <span className="text-slate-900 dark:text-yellow-500 font-medium">
                                    ...
                                    <td className="py-4 px-4 text-right">
                                      ...
                                      student.id ? (
                                        <div className="flex flex-col gap-2">
                                          <div className="flex items-center justify-end gap-2">
                                            <input
                                              ...
                                              className="w-32 bg-white dark:bg-[#131313] border border-yellow-500/50 rounded-lg px-3 py-1.5 text-slate-900 dark:text-white outline-none focus:border-yellow-500 text-sm"
                                              placeholder="Amount..."
                                              autoFocus
                                            />
                                          </div>
                                          ...
                                          <div className="flex items-center justify-end gap-2">
                                            <input
                                              ...
                                              className="w-32 bg-white dark:bg-[#131313] border border-slate-200 dark:border-white/10 rounded-lg px-3 py-1.5 text-slate-900 dark:text-white outline-none focus:border-yellow-500 text-sm"
                                          ...
                                          <div className="flex justify-end gap-2 mt-1">
                                            ...
                                            <button
                                              ...
                                              disabled={isPending}
                                              className="px-3 py-1.5 text-xs bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold rounded-lg transition-colors"
                                            >
                                              Save
                                            </button>
                                          </div>
                                        ...
                                        <button
                                          ...
                                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-900 dark:text-yellow-500 hover:text-yellow-500 bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/20 rounded-lg transition-colors"
                                        >
