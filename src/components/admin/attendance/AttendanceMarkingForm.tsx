    ...
    <div className="space-y-6">
        ...
        {students.length > 0 && (
          <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-200 dark:border-white/10 ">
            <button
              ...
              className="px-4 py-2 bg-green-100 text-green-700 rounded-lg font-medium text-sm hover:bg-green-200 transition-colors flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-red-100 text-red-700 rounded-lg font-medium text-sm hover:bg-red-200 transition-colors flex items-center gap-2"
            >
              <X className="w-4 h-4" />
              Mark All Absent
            </button>
      ...
      {loading ? (
        <div className="text-center py-12">
          <div className="inline-block animate-spin">
            <div className="w-8 h-8 border-4 border-slate-200 dark:border-white/10 border-t-yellow-600 rounded-full" />
          </div>
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg text-xs font-medium border transition-all ${
                                isActive
                                  ? config.color
                                  : "bg-slate-100 dark:bg-[#1c1b1b] text-slate-600 dark:text-slate-400 border-slate-200 dark:border-white/10 hover:border-neutral-300 "
                              }`}
                              title={config.label}
                            >
                              {config.icon}
      ...
      {filteredStudents.length > 0 && (
        <div className="mt-8 flex gap-4 justify-end animate-slide-up">
          <button
            onClick={handleReset}
            className="px-6 py-3 border border-slate-200 dark:border-white/10 rounded-lg font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-[#0a0a0a] transition-colors flex items-center gap-2"
          >
